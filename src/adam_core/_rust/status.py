...
API_MIGRATIONS: Final[tuple[ApiMigration, ...]] = (
    ...
    ApiMigration(
        ...
        coverage_note=(
            ...
            "finished VariantOrbits RecordBatch assembly. The 6D/9D sigma-point "
            "outputs are deterministic and tolerance-gated against frozen "
            "updated-upstream; weights remain bitwise-gated and reconstructed "
            "means/covariances are independently gated. Monte Carlo and the auto "
            "fallback use the Rust-native RNG "
