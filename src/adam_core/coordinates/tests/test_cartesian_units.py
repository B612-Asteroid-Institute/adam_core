...
class TestCartesianCoordinatesUnitMethods:
    ...
    def test_covariance_km_method_with_covariance(self, sample_coordinates_with_covariance):
    ...
    def test_unit_conversion_with_negative_values(self):
        ...
        assert coords.values_km[0, 3] == -0.01 * KM_P_AU / S_P_DAY  # -0.01 AU/day -> negative km/s
...
class TestCartesianCoordinatesIntegration:
    ...
    def test_round_trip_conversion_conceptual(self):
        ...
        np.testing.assert_allclose(values_au_round_trip, original_coords.values, rtol=1e-15)
    ...
    def test_covariance_round_trip_conversion(self):
        ...
        for i in range(N):
            ...
            cov_matrices[i] += np.eye(6) * 0.001  # Add small diagonal term for positive definiteness
