...
- [ ] RM-STANDALONE-ROADMAP: long-term standalone Rust surface map is captured in [`standalone_rust_surface_roadmap_2026-05-15.md`](standalone_rust_surface_roadmap_2026-05-15.md); after answering the roadmap's open product-scope questions (especially schema ownership and time-dependency posture), next standalone work should begin with a status registry and Rust-native data model RFC rather than isolated kernel ports.
