...
- [ ] RM-STANDALONE-006C: add first-class Rust variant propagation metadata (`VariantId`, `OrbitVariantBatch`, weights, and covariance weights) instead of representing variants only as repeated orbit rows.
