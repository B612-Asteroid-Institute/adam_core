...
- Branch `rust-migration-waves-d-e` now contains the Wave D/E Rust migration plus the standalone Rust foundation slices through RM-STANDALONE-006G. Current work remains standalone propagation/ephemeris foundation, not RM-STANDALONE-007 n-body implementation or the broad RM-PERF-001 benchmark-action audit.
